...
public class CodeGenerator {
    ...
    private static final String projectJavaPathDir =  "/eurekaClient/src/main/java";
    private static final String projectResourcePathDir =  "/eurekaClient/src/main/resources";
