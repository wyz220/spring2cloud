...
public class CodeGenerator {
    ...
    private static final String projectJavaPathDir =  "/provider-user-metadata/src/main/java";
    private static final String projectResourcePathDir =  "/provider-user-metadata/src/main/resources";
